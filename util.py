...
def create_parser():
    ...
    parser.add_argument("--save_name", default='model', type=str, help="Name of the saved model")
    ...
    parser.add_argument("--use_ppr", default=None, type=str, help="Use PPR for aggregation. Needs to be one of [ppr].")
    return parser
